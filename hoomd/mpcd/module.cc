...
PYBIND11_MODULE(_mpcd, m)
    ...
    mpcd::detail::export_SphereGeometry(m); // Sphere geometry
    ...
    mpcd::detail::export_ConfinedStreamingMethod<mpcd::detail::SphereGeometry>(m); // Sphere geometry
    #ifdef ENABLE_CUDA
    ...
    mpcd::detail::export_ConfinedStreamingMethodGPU<mpcd::detail::SphereGeometry>(m); // Sphere geometry
    #endif // ENABLE_CUDA
